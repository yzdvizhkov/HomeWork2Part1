...
let userFirstName: String = "Yura"
let userLastName: String = "Zdvizhkov"
var userAge: Int = 29
let userHeight: Double = 180.0
var userWeight: Double = 77
...
print("Користувач авторизований: \(userLoggedIn)")
userLoggedIn = true
print("Користувач авторизований: \(userLoggedIn!)")
